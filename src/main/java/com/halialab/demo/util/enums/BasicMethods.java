...
public enum BasicMethods implements ChainMethod {
	  ...
	  COMMAND_GET_ADDRESS_BALANCE("getaddressbalances"),
	  COMMAND_GET_MULTI_BALANCE("getmultibalances"),
	  COMMAND_SEND_ASSETS_FROM("sendassetfrom"),
	  COMMAND_SEND_ASSETS("sendasset"),
